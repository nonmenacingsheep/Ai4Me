...
- **Voice presence** — her speech takes on her mood: a mood-matched voice, pace/pitch/volume shaping, and natural breath between sentences. There's also **"The Boiled One"** — a horror voice that replaces her normal speech with a breathy analog-horror rasp (eSpeak NG, routed through the voice changer so it's still her underneath) the whole time it's on. Each is an independent toggle in **Settings → Behavior → Voice presence**; `ESPEAK_WHISPER_*` tunes the horror voice.
